...
| markerColor     | Color of the marker    | 'blue'        | 'red', 'blue', 'green', 'purple', 'orange', 'darkred', 'lightred', 'beige', 'darkblue', 'darkgreen', 'cadetblue', 'darkpurple', 'white', 'pink', 'lightblue', 'lightgreen', 'gray', 'black', 'lightgray'. See [markers-soft@2x.png](https://github.com/lvoogdt/Leaflet.awesome-markers/blob/2.0/develop/dist/images/markers-soft%402x.png). |
